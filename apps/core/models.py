...
class Product(models.Model):
    ...
    volume = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="Крепость")
    beerDensity = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="Плотность пива")
